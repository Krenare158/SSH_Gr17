...
function EkstraFam() {
    ...
    return (
        <div className="Custom-form-container">
            <h1>Shkarko "Ekstraktin" për anëtar të familjes</h1>
            <fieldset className="Custom-form-wrapper">
                <form onSubmit={handleSubmit}>
                    <div className="Custom-left-col">
                        <p className="Custom-para"><b>Ekstrakti nga regjistri qëndror i gjendjes civile</b></p>
